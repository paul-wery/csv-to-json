    ...
    disabled:pointer-events-none disabled:opacity-50 active:[&>*]:translate-y-0.5`,
  {
    variants: {
      variant: {
        ...
        "primary-300": "bg-primary-300 text-black hover:bg-primary-300/90",
        dark: "bg-primary2 text-primary2-foreground hover:bg-primary2/90 fill-white",
        darkOutline:
          "bg-white border border-primary2 text-primary2 hover:bg-primary2/10 fill-primary2",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border border-input bg-background hover:bg-accent hover:text-accent-foreground",
        outlinePrimary: `border-primary bg-background border hover:border-primary/80`,
        secondary:
        ...
        inline: "!h-fit [&>*]:!p-0 text-primary font-medium",
        custom: "",
      },
      size: {
